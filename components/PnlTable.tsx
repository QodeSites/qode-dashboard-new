...
export function PnlTable({
  ...
  const renderQuarterlyTable = () => {
    ...
    return (
      <Card className="bg-white/50 backdrop-blur-sm p-0 card-shadow border-0">
          ...
          <div className="w-full overflow-x-auto">
            <table className="min-w-full border-collapse divide-y">
              <thead className="bg-lightBeige">
                <tr className="bg-black/5 border-gray-300 border-b text-sm">
                  ...
                  <th className="text-center px-4 py-2 text-sm font-medium text-black uppercase tracking-wider min-w-[80px] border-l-2 border-gray-300">
                    Total
                  </th>
                </tr>
              </thead>
