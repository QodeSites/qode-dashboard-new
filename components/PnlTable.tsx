          ...
          <div className="flex justify-between items-center">
            <CardTitle className="text-sm sm:text-lg text-gray-900">
              ...
              {(showOnlyQuarterlyCash || showPmsQawView) && (
                <span className="text-xs text-gray-600 ml-2">(Cash values only)</span>
              )}
            </CardTitle>
            {!showOnlyQuarterlyCash && !showPmsQawView && (
            ...
            <table className="min-w-full border-collapse divide-y">
              ...
              <tbody className="divide-y">
                {quarterlyYears.map((year) => (
                  <tr key={`${year}-${displayType}`} className="hover:bg-gray-50 border-gray-300 text-xs">
          ...
          <div className="mt-6 pt-4 border-t border-gray-200">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs text-gray-600">
              <div className="space-y-1">
                ...
                {(showOnlyQuarterlyCash || showPmsQawView) && (
                  <p className="text-blue-600"><strong>Note:</strong> Quarterly data shows cash values only</p>
                )}
              </div>
        ...
        <CardHeader>
          <div className="flex justify-between items-center">
            <CardTitle className="text-sm sm:text-lg text-gray-900">
              ...
              {showPmsQawView && <span className="text-xs text-gray-600 ml-2">(Percentage values only)</span>}
            </CardTitle>
            {!showPmsQawView && (
              <div className="space-x-2">
                <Button
          ...
          <div className="mt-6 pt-4 border-t border-gray-200">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs text-gray-600">
              <div className="space-y-1">
                ...
                {showPmsQawView && (
                  <p className="text-blue-600"><strong>Note:</strong> Monthly data shows percentage values only</p>
                )}
              </div>
              <div className="flex gap-4">
                <p className="text-green-600">Green: Positive values</p>
