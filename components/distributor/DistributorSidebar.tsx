...
/**
 * Distributor-specific sidebar. Mirrors the visual structure and styling of
 * the regular `components/sidebar.tsx` but with a fixed set of nav items
 * (Home, QYE++, QAW++) and no user info or logout section.
 *
 * Logout lives in the header bar instead (per design decision).
 */
...
export function DistributorSidebar({ open, setOpen }: DistributorSidebarProps) {
