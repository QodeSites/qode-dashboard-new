...
import { round, isActive, MS, mean, std, parseOptionalDate } from "@/lib/utils";
import {
  calcSinceInception,
  calcMaxDrawdown,
  calcCurrentDrawdown,
...
import { computePortfolioSummary } from "@/app/lib/portfolio-review/portfolio-summary";
import { computeStrategyBreakup } from "@/app/lib/portfolio-review/strategy-breakup";
import type {
  StrategyBreakupRow,
  StrategyBreakupResult,
} from "@/app/lib/portfolio-review/strategy-breakup";
import { computeAccountValueBreakup } from "@/app/lib/portfolio-review/account-value-breakup";
import type {
  AccountRow,
  EquityBreakupRow,
  AccountValueBreakupResult,
} from "@/app/lib/portfolio-review/account-value-breakup";
import {
  SUB_STRATEGY_SECTION_ORDER,
...
import type {
  ...
  BacktestSeries,
  CompareOutput,
} from "@/app/lib/portfolio-review/compare";

// Re-exported so every existing route import (`from "@/app/lib/internal-utils"`)
// keeps working unchanged even though the implementations now live in
...
export { fetchBenchmark, calcCaptureRatios, calcExtraRatios };
export { computePortfolioSummary };
export { parseOptionalDate };
export type { StrategyBreakupRow, StrategyBreakupResult };
export { computeStrategyBreakup };
export type { AccountRow, EquityBreakupRow, AccountValueBreakupResult };
export { computeAccountValueBreakup };
export { SUB_STRATEGY_SECTION_ORDER };
export type {
  SubStrategyRow,
  SubStrategyPerformanceResult,
  DailyPnlSelection,
